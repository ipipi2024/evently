...
export default async function Home({ searchParams }: SearchParamProps) {
  ...
  return (
    <>
      <section className="bg-primary-50 dark:bg-gray-900 bg-dotted-pattern bg-contain py-5 md:py-10">
        <div className="wrapper grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0">
          <div className="flex flex-col justify-center gap-8">
            ...
            <p className="p-regular-20 md:p-regular-24 text-gray-800 dark:text-gray-300">
              Book and learn helpful tips from 3,168+ mentors in world-class companies with our global community.
            </p>
            <Button 
              size="lg" 
              asChild 
              className="button w-full sm:w-fit bg-primary hover:bg-primary/90 dark:bg-primary dark:hover:bg-primary/90"
            >
              <Link href="#events">
                Explore Now
              </Link>
          ...
          <Image 
            ...
            width={1000}
            height={1000}
            className="max-h-[70vh] object-contain object-center 2xl:max-h-[50vh] dark:opacity-90"
          />
        </div>
      </section> 
      ...
      >
        <h2 className="h2-bold text-gray-900 dark:text-white">
